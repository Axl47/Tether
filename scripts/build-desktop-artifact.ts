...
const BuildEnvConfig = Config.all({
  platform: Config.schema(BuildPlatform, "TETHER_DESKTOP_PLATFORM").pipe(Config.option),
  target: Config.string("TETHER_DESKTOP_TARGET").pipe(Config.option),
  arch: Config.schema(BuildArch, "TETHER_DESKTOP_ARCH").pipe(Config.option),
  version: Config.string("TETHER_DESKTOP_VERSION").pipe(Config.option),
  outputDir: Config.string("TETHER_DESKTOP_OUTPUT_DIR").pipe(Config.option),
  skipBuild: Config.boolean("TETHER_DESKTOP_SKIP_BUILD").pipe(Config.withDefault(false)),
  keepStage: Config.boolean("TETHER_DESKTOP_KEEP_STAGE").pipe(Config.withDefault(false)),
  signed: Config.boolean("TETHER_DESKTOP_SIGNED").pipe(Config.withDefault(false)),
  verbose: Config.boolean("TETHER_DESKTOP_VERBOSE").pipe(Config.withDefault(false)),
});
...
const buildDesktopArtifact = Effect.fn("buildDesktopArtifact")(function* (
  ...
  const stagePackageJson: StagePackageJson = {
    ...
    build: yield* createBuildConfig(
      options.platform,
      options.target,
      desktopPackageJson.productName ?? "Tether",
      options.signed,
    ),
    dependencies: {
