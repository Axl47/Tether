...
const PERSISTED_STATE_KEY = "tether:renderer-state:v8";
const LEGACY_PERSISTED_STATE_KEYS = [
  "tether:renderer-state:v6",
  "tether:renderer-state:v5",
  "tether:renderer-state:v4",
  "tether:renderer-state:v3",
...
function resolveWsHttpOrigin(): string {
  ...
  if (wsUrl.length === 0) return window.location.origin;
