...
interface ChatMarkdownProps {
  ...
  isStreaming?: boolean;
  searchContentId?: string | undefined;
}
...
function ChatMarkdown({ text, cwd, isStreaming = false, searchContentId }: ChatMarkdownProps) {
  ...
  return (
    <div
      ...
      data-thread-search-content={searchContentId}
    >
