// This file mostly exists because we want dev mode to say "Tether (Dev)" instead of "electron"
...
const APP_BUNDLE_ID = isDevelopment ? "com.axorio.tether.dev" : "com.axorio.tether";
