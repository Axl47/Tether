...
| ----------------------- | --------------------- | ---------------------------------- |
| `--mode <web\|desktop>` | `TETHER_MODE`         | Runtime mode.                      |
| `--port <number>`       | `TETHER_PORT`         | HTTP/WebSocket port.               |
| `--host <address>`      | `TETHER_HOST`         | Bind interface/address.            |
| `--state-dir <path>`    | `TETHER_STATE_DIR`    | State directory.                   |
