...
export const MODEL_OPTIONS_BY_PROVIDER = {
  ...
  gemini: [
    ...
    { slug: "gemini-2.5-flash-image", name: "Gemini 2.5 Flash Image" },
    { slug: "gemini-3-pro-preview", name: "Gemini 3 Pro Preview" },
    { slug: "gemini-3-pro-image-preview", name: "Gemini 3 Pro Image Preview" },
...
export const MODEL_SLUG_ALIASES_BY_PROVIDER = {
  ...
  gemini: {
    ...
    "nano-banana-2": "gemini-3-pro-image-preview",
    "nanobanana2": "gemini-3-pro-image-preview",
